...
tab11.markdown("""### ・在由于新冠疫情暂时停办三年之后，第七届“地理信息技术在公共卫生领域的应用”讲习班今年于6月27日29日在上海恢复举办并取得圆满成功。这一由国际华人地理信息科学协会（CPGIS）主办的讲习班系列已经举办了七届。自2016年第三届起，该讲习班由华东师范大学地理科学学院承办。""")
tab11.markdown("""### ・今年有将近130名同仁报名参与讲习班，创历史新高。这些同仁来自17个省、直辖市、特别行政区、自治区，39家单位，包括高校、科研院所、政府职能部门，参会者背景以公共卫生、地理、城市规划居多。""")
tab11.markdown("""### ・今年共有18位来自国内外的老师为讲习班提供了专题讲座或软件培训，涉及健康地理、健康GIS的各个方面，既展现了这一领域最热门的题目，最前沿的探索，最崭新的成果，也普及了这一领域的基础知识和基本技能。""")
tab11.markdown("""### ・尤其是本次讲习班在正式开始之前，增加了一天的GIS软件基础培训，深受参会者的欢迎。讲习班的具体内容见上端 [会议日程] 栏目""")
tab11.markdown("""### ・本次讲习班特别邀请到国际著名学者，英国社会科学院院士，美国地理学家协会杰出学术成就奖获得者，香港中文大学的关美宝教授到场。关教授的“面向健康研究的大数据与地理空间技术”的精彩报告将讲习班的学术水平带到了一个新层次。""")
tab11.markdown("""### ・在会后的问卷调查中，参会的同仁对讲习班的内容、形式、组织给与了热烈反馈，为进一步办好这个讲习班提供宝贵的意见和建议，如增加讨论和互动环节的时间等。""")
tab11.markdown("""### ・本次协办单位包括中国地理学会健康地理专业委员会、中国地理学会地理模型与地理信息分析专业委员会、中国地理学会环境地理专业委员会；承办单位包括华东师范大学地理科学学院、地理信息科学教育部重点实验室、自然资源部超大城市自然资源时空大数据分析应用重点实验室、联合国可持续发展大数据国际研究中心分中心CBAS-ECNU；特别鸣谢上海地听信息科技有限公司、Esri中国信息科技有限公司上海分公司的支持。""")
...
tab2.caption("1.讲座")
tab2.caption("将邀请知名学者介绍地理信息科学与技术在流行病学、环境健康、医疗服务资源配置等领域的应用。主讲学者包括（以下按姓氏笔画排列）：")
...
tab2.caption("2.讨论")
tab2.caption("将邀请参加讲座的学者以讨论形式就科研及业务部门关心的若干问题进行深入探讨，与大家开展广泛交流。也欢迎大家带着实际数据或问题来参与讨论。")

tab2.subheader("（二）培训内容及授课师资")
tab2.caption("培训将采用上机实习的方式，普及有关理论方法和软件技术，同时探讨在中国具体环境下的应用。需要学员对GIS有基本的了解和兴趣。培训内容分为以下两部分：")
...
tab31,tab32 = tab3.columns(2)
tab31.image(image627,caption=' ',width=900,use_column_width=False)
tab32.image(image628,caption=' ',width=900,use_column_width=False)
tab31.image(image629,caption=' ',width=900,use_column_width=False)
tab32.image(image626,caption=' ',width=900,use_column_width=False)
