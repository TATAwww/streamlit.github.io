...
tab11.markdown("""<span>本次会议协办单位包括中国地理学会健康地理专业委员会、中国地理学会地理模型与地理信息分析专业委员会、中国地理学会环境地理专业委员会；承办单位包括华东师范大学地理科学学院、地理信息科学教育部重点实验室、自然资源部超大城市自然资源时空大数据分析应用重点实验室、联合国可持续发展大数据国际研究中心分中心CBAS-ECNU；特别鸣谢上海地听信息科技有限公司、Esri中国信息科技有限公司上海分公司的支持。</span>""",unsafe_allow_html=True)
