...
tab11.markdown("""<span>emsp;&emsp;在由于新冠疫情暂时停办三年之后，第七届“地理信息技术在公共卫生领域的应用”讲习班今年于6月27日29日在上海恢复举办并取得圆满成功。这一由国际华人地理信息科学协会（CPGIS）主办的讲习班系列已经举办了七届。自2016年第三届起，该讲习班由华东师范大学地理科学学院承办。</span>""",unsafe_allow_html=True)
